...
class TestRunwayReplay:
    ...
    def setup_method(self):
        ...
        self.service = ProofOfValueService(self.mock_db)
    ...
    def test_generate_runway_replay_success(self, mock_qbo_data):
        ...
        with patch('runway.test_drive.services.proof_of_value.get_qbo_provider') as mock_get_provider:
            mock_provider = Mock()
            ...
            result = self.service.generate_runway_replay("test-business-123")
    ...
    def test_generate_runway_replay_business_not_found(self):
        """Test runway replay when business doesn't exist."""
        self.mock_db.query.return_value.filter.return_value.first.return_value = None
        
        with pytest.raises(BusinessNotFoundError):
            self.service.generate_runway_replay("nonexistent-business")
    
    def test_generate_runway_replay_error_handling(self):
    ...
    def test_weekly_analysis_generation(self, mock_qbo_data):
        ...
        # Test the OnboardingService directly since that's where _generate_weekly_analysis lives
        from runway.onboarding.services.onboarding import OnboardingService
        service = OnboardingService(self.mock_db)
    ...
    def test_runway_replay_integration_with_qbo_connection(self):
...
class TestRunwayReplayAPI:
    ...
    def test_runway_replay_endpoint_structure(self):
        ...
        from runway.test_drive.routes.test_drive import get_runway_replay
