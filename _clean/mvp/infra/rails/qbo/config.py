...
class QBOConfig:
    ...
    def get_auth_url(self, state: str, business_id: str) -> str:
        """Generate the auth URL for OAuth flow."""
...
def is_qbo_production() -> bool:
    """Check if QBO is in production mode."""
    return qbo_config.is_production

def is_qbo_sandbox() -> bool:
    """Check if QBO is in sandbox mode."""
    return qbo_config.is_sandbox
