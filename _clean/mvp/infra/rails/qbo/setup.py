...
# from runway.services.experiences.test_drive import DemoTestDriveService  # Commented out - test drive not supported in MVP
# Removed domains dependency - using DTOs instead
from mvp.infra.config.exceptions import IntegrationError
...
class QBOSetupService:
    ...
    async def complete_qbo_connection(self, state: str, code: str, realm_id: str) -> Dict[str, Any]:
        ...
        # Test drive not supported in MVP
