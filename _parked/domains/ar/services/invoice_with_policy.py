...
# from _parked.policy.services.policy_engine import PolicyEngineService  # Moved to _parked/
...
class InvoiceService(TenantAwareService):
    ...
    async def sync_invoices(self, business_id: int) -> List[Invoice]:
        ...
        try:
            ...
            # SmartSyncService handles caching and activity recording internally
