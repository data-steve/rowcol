...
class PreCloseCheck(Base, TimestampMixin, TenantMixin):
    ...
    business = relationship("Business", back_populates="preclose_checks")
...
class Exception(Base, TimestampMixin, TenantMixin):
    ...
    business = relationship("Business", back_populates="exceptions")
...
class PBCRequest(Base, TimestampMixin, TenantMixin):
    ...
    business = relationship("Business", back_populates="pbc_requests")
...
class CloseChecklist(Base, TimestampMixin, TenantMixin):
    ...
    business = relationship("Business", back_populates="close_checklists")
